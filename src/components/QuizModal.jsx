        ...
        <Dialog.Panel className="p-6 mx-auto max-w-4xl max-h-[95vh] rounded bg-white overflow-y-auto">
          ...
          <form onSubmit={onFormSubmit} noValidate className="my-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                className="inline-flex justify-center rounded-md border border-transparent bg-yellow-100 px-2 py-1 font-main text-xs md:text-sm lg:text-base tracking-wide text-yellow-600 hover:bg-yellow-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-600 focus-visible:ring-offset-2"
              >
                Add
              </button>
            </div>
